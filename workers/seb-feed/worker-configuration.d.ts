/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d34fd32bd5222634fcde93a716f576ad)
// Runtime types generated with workerd@1.20260521.1 2026-04-24 
interface __BaseEnv_Env {
	HITS_KV: KVNamespace;
	RATE_LIMIT_FEED: RateLimit;
	RATE_LIMIT_HIT: RateLimit;
	RATE_LIMIT_GUESTBOOK_POST: RateLimit;
	RATE_LIMIT_CONTACT_POST: RateLimit;
	RATE_LIMIT_STRING_SOCKET: RateLimit;
	RATE_LIMIT_COROOM_SOCKET: RateLimit;
	RATE_LIMIT_BFV_QUALIFY: RateLimit;
	RATE_LIMIT_BFV_SOCKET: RateLimit;
	RATE_LIMIT_THIS_PERSON: RateLimit;
	AI: Ai;
	...
	STRING_ROOM: DurableObjectNamespace<import("./src/index").StringRoom>;
	CO_ROOM: DurableObjectNamespace<import("./src/index").CoRoom>;
	BFV_ROOM: DurableObjectNamespace<import("./src/index").BodyForVisitsRoom>;
	THIS_PERSON_ROOM: DurableObjectNamespace<import("./src/index").ThisPersonRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "StringRoom" | "CoRoom" | "BodyForVisitsRoom" | "ThisPersonRoom";
	}
